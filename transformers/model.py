...
class InputEmbedding(nn.Module):
    ...
    def forward(self,x):
        ...
        # batch_size: số mẫu được xử lý trong 1 lần forward pass
        # seq_len: số từ/ token trong 1 câu
...
build_transformer(src_vocab_size:int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len:int, d_model: int = 512, N: int = 6, h: int = 8, d_ff: int = 2048, dropout: float = 0.1) -> Transfomer:
    ...
    transformer = Transfomer(encoder, decoder, src_emb, tgt_emb, projection_layer, src_pos, tgt_pos)
